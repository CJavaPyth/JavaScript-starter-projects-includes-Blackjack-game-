...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    resetBtn3.innerHTML = "<button class='btn btn-danger' style= 'height=30 width=30'>"
    document.getElementById('flex-box-rps-div').appendChild(resetBtn3);*/
...
// event listener works similar to onChange() and onClick() 
